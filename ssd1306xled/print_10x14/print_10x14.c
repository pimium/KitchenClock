...
ssd1306_oled* font10x14_init(){
    font10x14 *f = malloc(sizeof(font10x14));
    font_init(&(f->super));
    f->super.put_string = ssd1306_string_font10x14;
    f->super.put_char = ssd1306_char_font10x14;
...
void ssd1306_string_font10x14(uint8_t posx, uint8_t posy, char *s) {
    while (*s) {
        ...
        ssd1306_char_font10x14(posx, posy, *s++);
        posx += FONT_WIDTH+1;
    }
}
